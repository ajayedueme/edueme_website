...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_alumni_activities`(`pubName`, `pubDocument`, `pubContent`, `pubOrder`, `status`, `addOn`) VALUES ('{$txtname}', '{$thumbfile2}', '{$txtcontent}',  '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:alumni_activitis.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add Alumni Activitis</h1>
      <ol class="breadcrumb">
	  <li><a href="alumni_activitis.php">Alumni Activitis List</a></li>
        <li class="active">Add Alumni Activitis</li>
    </ol>
			...
			<div class="panel panel-default">  <br>
				...
				<form name="frmChangepassword" id="frmChangepassword" enctype="multipart/form-data"  action="" method="POST">
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="txtcontent" id="elm1" ></textarea>
					</div>
					<div class="form-group">
