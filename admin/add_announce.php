...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	if($_FILES['txtDocument']['name'] !=""){
		...
		move_uploaded_file($tempimagename2,'../announcement/'.$imagename2);
	}else{
		$thumbfile2="";
	}
	$sqladd = "INSERT INTO `tbl_mjcet_announcements`(`pageUrl`, `pubName`, `pubDocument`, `pubOrder`, `status`, `addOn`) VALUES ('{$txturl}', '{$txtname}', '{$thumbfile2}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:announcements.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add Announcement</h1>
      <ol class="breadcrumb">
	  <li><a href="announcements.php">Announcements List</a></li>
		...
		<div class="col-md-12 col-lg-6">
			<div class="panel panel-default">  <br>
				...
				<form name="frmChangepassword" id="frmChangepassword" enctype="multipart/form-data"  action="" method="POST">
					...
					<div class="form-group">
						<label for="input1" class="form-label">Image/Document: </label>
