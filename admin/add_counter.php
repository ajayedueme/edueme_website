...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_counter`(`pubName`, `pubNumber`, `pubOrder`, `status`, `addOn`) VALUES ('{$txtname}', '{$txtNumber}', '{$txtOrder}', '1', Now())";
		...
		<div class="col-md-12 col-lg-6">
			<div class="panel panel-default">  <br>
				...
				<form name="frmChangepassword" id="frmChangepassword" enctype="multipart/form-data"  action="" method="POST">
					...
					<div class="form-group">
						<label for="input1" class="form-label">Counter Number: </label>
