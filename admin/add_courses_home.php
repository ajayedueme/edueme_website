...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_courses`( `courses_name`, `courses_image`, `about_courses`, `status`, `order`, `addOn`,`tag_line`,`courses_cat_id`) VALUES ( '{$txtname}', '{$thumbfile1}', '{$txtAbout}', '1','{$order}', Now(),'{$tag_line}','{$catname}')";
		...
		<div class="col-md-12 col-lg-6">
			...
			<div class="panel-body">
                ...
                <div class="form-group">
						<label for="input1" class="form-label">Select cat: </label>
				        ...
				        while($row_faq = mysqli_fetch_object($res_faq)){ ?>
                            <option value="<?php echo stripslashes($row_faq->id);?>"><?php echo stripslashes($row_faq->title);?></option>
                        <?php } ?>
                        </select>
					</div>
					...
					<div class="form-group">
						...
						<input type="file" class="form-control" name="txtThumb" id="txtImage" >
					</div>
					<div class="form-group">
