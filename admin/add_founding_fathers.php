...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	if($_FILES['txtImg']['name'] !=""){
		$thumbfile1= $_FILES['txtImg']['name'];
		$imagename1= $_FILES['txtImg']['name'];
		$tempimagename1= $_FILES['txtImg']['tmp_name'];
		move_uploaded_file($tempimagename1,'../uploades/'.$imagename1);
	}else{
		$thumbfile1="";
	}
	
	$sqladd = "INSERT INTO `tbl_mjcet_founding_fathers`(`pageUrl`, `pubName`, `pubDocument`, `pubImg`, `pubContent`, `pubOrder`, `status`, `addOn`) VALUES ('{$txturl}', '{$txtname}', '{$thumbfile2}', '{$thumbfile1}', '{$txtContent}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:founding_fathers.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add </h1>
      <ol class="breadcrumb">
	  <li><a href="founding_fathers.php">Founding Fathers List</a></li>
			...
			<div class="panel panel-default">  <br>
				...
				<form name="frmChangepassword" id="frmChangepassword" enctype="multipart/form-data"  action="" method="POST">
					...
					<div class="form-group">
						...
						<textarea type="text" class="form-control" name="txtname" id="txtname" ></textarea>
					</div>
