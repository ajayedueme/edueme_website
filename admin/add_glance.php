...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_glance`(`name`, `icon`, `corder`, `status`, `addOn`) VALUES ('{$txtName}', '{$thumbfile1}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	$lattid = mysqli_insert_id($con);

	header('Location:glance.php?msg=4');
	exit();
  ...
  <!-- Start Page Header -->
	<div class="page-header">
		<h1 class="title">Add</h1>
		  <ol class="breadcrumb">
		  <li><a href="glance.php">Glance List</a></li>
