...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_imp_links`(`pageUrl`, `pubName`, `pubDocument`, `pubImg`, `pubContent`, `pubOrder`, `status`, `addOn`) VALUES ('{$txturl}', '{$txtname}', '{$thumbfile2}', '{$thumbfile1}', '{$txtContent}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:imp_links.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add Important Links</h1>
      <ol class="breadcrumb">
	  <li><a href="imp_links.php">Important Links List</a></li>
