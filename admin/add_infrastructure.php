...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_infrastructure`(`pageUrl`, `pubName`, `pubDocument`, `pubImg`, `pubContent`, `pubOrder`, `status`, `addOn`) VALUES ('{$txturl}', '{$txtname}', '{$thumbfile2}', '{$thumbfile1}', '{$txtContent}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:infrastructure.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add Infrastructure</h1>
      <ol class="breadcrumb">
	  <li><a href="infrastructure.php">Infrastructure List</a></li>
        <li class="active">Add Infrastructure</li>
    </ol>
