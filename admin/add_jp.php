...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_jp`(`name`, `url`, `journalsCount`, `corder`, `status`, `addOn`) VALUES ('{$txtName}', '{$txtURL}', '{$txtNumber}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	$lattid = mysqli_insert_id($con);

	header('Location:jp.php?msg=4');
	exit();
  ...
  <!-- Start Page Header -->
	<div class="page-header">
		<h1 class="title">Add</h1>
		  <ol class="breadcrumb">
		  <li><a href="jp.php">Journals & Periodicals List</a></li>
