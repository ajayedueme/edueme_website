...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_labmanual`(`pubSulg`, `pubName`, `pubDocument`, `pubOrder`, `status`, `addOn`) VALUES ('{$publication}', '{$txtname}', '{$thumbfile2}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:labmanual.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add Laboratory Manual</h1>
      <ol class="breadcrumb">
	  <li><a href="labmanual.php">Laboratory Manuals List</a></li>
				...
				<form name="frmChangepassword" id="frmChangepassword" enctype="multipart/form-data"  action="" method="POST">
					...
					<div class="form-group">
						...
						<select class="form-control" name="publication" id="publication">
							...
							<?php 
								$pub = mysqli_query($con, "SELECT * FROM `tbl_mjcet_megha_menu_dept_section` WHERE menuName = 'Laboratory Manuals' AND status='1'"); 
							...
							<?php } ?>
							<?php 
								$coursePub = mysqli_query($con, "SELECT * FROM `tbl_mjcet_megha_menu_courses` WHERE menuName = 'Laboratory Manuals' AND status='1'"); 
