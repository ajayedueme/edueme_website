...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_laboratorie`(`deptMenu`, `deptLaboratorie`, `menuSulg`, `banOrder`, `status`, `addOn`) VALUES ('{$department}', '{$txtName}', '{$menusulg}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:laboratories.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add Banner</h1>
      <ol class="breadcrumb">
	  <li><a href="laboratories.php">Banners List</a></li>
