...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_main_menu`(`menuType`, `menuSulg`, `menuName`, `menuDocument`, `menuImage`, `menuContent`, `menuOrder`, `status`, `addOn`) VALUES ('{$txtMenuType}', '{$txtUrl}', '{$txtMenuname}', '{$thumbfile1}', '{$thumbfile2}', '{$txtMenuContent}', '{$txtMenuOrder}', '1', Now())";
