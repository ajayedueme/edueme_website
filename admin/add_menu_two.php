...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_second_menu`(`menuType`, `menuSulg`, `menuName`, `menuDocument`, `menuContent`, `menuOrder`, `status`, `addOn`) VALUES ('{$txtMenuType}', '{$txtUrl}', '{$txtMenuname}', '{$thumbfile1}', '{$txtMenuContent}', '{$txtMenuOrder}', '1', Now())";
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add Second Menu</h1>
      <ol class="breadcrumb">
	  <li><a href="menu_two.php">Menu Second List</a></li>
        <li class="active">Add Second Menu</li>
    </ol>
