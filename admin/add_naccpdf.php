...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	if($_FILES['txtDocument']['name'] !=""){
		...
		move_uploaded_file($tempimagename2,'../nacc-documents/'.$imagename2);
	}else{
		$thumbfile2="";
	}
	$sqladd = "INSERT INTO `tbl_mjcet_nacc_pdf`(`pdfName`, `pdf`, `status`, `addOn`) VALUES ('{$txtname}', '{$thumbfile2}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:pdf.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add</h1>
      <ol class="breadcrumb">
	  <li><a href="nacc-pdf.php">PDFs List</a></li>
