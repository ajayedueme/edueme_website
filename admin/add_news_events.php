...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_news_events`(`pageUrl`, `pubName`, `pubDocument`, `pubImg`, `pubContent`, `pubOrder`, `status`, `addOn`) VALUES ('{$txturl}', '{$txtname}', '{$thumbfile2}', '{$thumbfile1}', '{$txtContent}', '{$txtOrder}', '1', Now())";
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add News & Events</h1>
      <ol class="breadcrumb">
	  <li><a href="news_events.php">News & Events List</a></li>
