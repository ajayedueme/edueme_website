...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_newsletter`(`pubSulg`, `pubName`, `pubDocument`, `pubOrder`, `status`, `addOn`) VALUES ('{$publication}', '{$txtname}', '{$thumbfile2}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:newsletter.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add News Letter</h1>
      <ol class="breadcrumb">
	  <li><a href="newsletter.php">News Letter List</a></li>
			...
			<div class="panel panel-default">  <br>
				...
				<form name="frmChangepassword" id="frmChangepassword" enctype="multipart/form-data"  action="" method="POST">
					...
					<div class="form-group">
						<label for="input1" class="form-label">News Letter Category: </label>
						<select class="form-control" name="publication" id="publication">
							<option value="">Select</option>
							<?php 
								$pub = mysqli_query($con, "SELECT * FROM `tbl_mjcet_megha_menu_dept_section` WHERE menuName = 'News Letter' AND status='1'"); 
