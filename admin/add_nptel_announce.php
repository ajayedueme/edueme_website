...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_nptel_announcements`(`pageUrl`, `pubName`, `pubDocument`, `pubOrder`, `status`, `addOn`) VALUES ('{$txturl}', '{$txtname}', '{$thumbfile2}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:nptel_announcements.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add NPTEL Announcement</h1>
      <ol class="breadcrumb">
	  <li><a href="laboratories.php">NPTEL Announcements List</a></li>
        <li class="active">Add NPTEL Announcement</li>
    </ol>
