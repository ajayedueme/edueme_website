...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_other_institutions`(`pageUrl`, `pubName`, `pubDocument`, `pubImg`, `pubContent`, `pubOrder`, `status`, `addOn`) VALUES ('{$txturl}', '{$txtname}', '{$thumbfile2}', '{$thumbfile1}', '{$txtContent}', '{$txtOrder}', '1', Now())";
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add Other Institutions</h1>
      <ol class="breadcrumb">
	  <li><a href="other_institutions.php">Other Institutions List</a></li>
        <li class="active">Add Other Institutions</li>
    </ol>
