...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
    ...
    $sqladd = "INSERT INTO `tbl_pages`(`pageHeading`, `pageMenuId`, `pageImage`, `pageContent`, `status`, `addOn`,`tagline`,`order`,`txtMenuContentShort`) VALUES ('{$txtUrl}', '{$txtMenuname}', '{$thumbfile2}', '{$txtMenuContent}', '1', Now(),'{$tagline}','{$order}','{$txtMenuContentShort}')";
		...
		<div class="col-md-12 col-lg-6">
			<div class="panel panel-default">  <br>
                ...
                <div class="form-group">
                        ...
                        <select name="txtMenuname" id="txtMenuname" class="form-control">
                        <option value="">Select</option>
                        <?php 
					    $i=1;
				        while($row_faq = mysqli_fetch_object($res_faq)){ ?>
                            <option value="<?php echo stripslashes($row_faq->menuId);?>"><?php echo stripslashes($row_faq->menuName);?></option>
                        <?php } ?>
                        </select>
					</div>
                    ...
                    <div class="form-group">
						...
						<textarea id="elm1" name="txtMenuContentShort"></textarea>
                    </div>
					<div class="form-group">
