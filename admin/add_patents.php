...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_patents`(`pubSulg`, `pubName`, `pubDocument`, `pubOrder`, `status`, `addOn`) VALUES ('{$publication}', '{$txtname}', '{$thumbfile2}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:patents.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add Patents</h1>
      <ol class="breadcrumb">
	  <li><a href="patents.php">Patents List</a></li>
        <li class="active">Add Patents</li>
    </ol>
			...
			<div class="panel panel-default">  <br>
				...
				<form name="frmChangepassword" id="frmChangepassword" enctype="multipart/form-data"  action="" method="POST">
					...
					<div class="form-group">
						<label for="input1" class="form-label">Patents Category: </label>
						<select class="form-control" name="publication" id="publication">
							<option value="">Select</option>
							<?php 
								$pub = mysqli_query($con, "SELECT * FROM `tbl_mjcet_megha_menu_dept_section` WHERE menuName = 'Patents' WHERE status='1'"); 
