...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_side_menu`(`menuSulg`, `menuName`, `menuDocument`, `menuImage`, `menuContent`, `menuOrder`, `status`, `addOn`) VALUES ('{$txtUrl}', '{$txtMenuname}', '{$thumbfile1}', '{$thumbfile2}', '{$txtMenuContent}', '{$txtMenuOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
		
	header('Location:popupmenu.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add </h1>
      <ol class="breadcrumb">
	  <li><a href="popupmenu.php">Side Menu List</a></li>
