...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_side_submenu`(`menuType`, `menuSulg`, `menuName`, menuTitle, `menuDocument`, `menuContent`, menuContentTwo,`menuImage`, `menuOrder`, `status`, `addOn`) VALUES ('{$txtMenuType}', '{$txtUrl}', '{$txtMenuname}', '{$menuTitle}', '{$thumbfile1}', '{$txtMenuContent}', '{$txtMenuContent2}', '{$imagename2}', '{$txtMenuOrder}', '1', Now())";
