...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_professional`(`pubSulg`, `pubName`, `pubDocument`, `pubUrl`, `pubOrder`, `status`, `addOn`) VALUES ('{$publication}', '{$txtname}', '{$thumbfile2}', '{$txturl}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:professional.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add Professional Chapters</h1>
      <ol class="breadcrumb">
	  <li><a href="mous.php">Professional Chapters List</a></li>
			...
			<div class="panel panel-default">  <br>
				...
				<form name="frmChangepassword" id="frmChangepassword" enctype="multipart/form-data"  action="" method="POST">
					...
					<div class="form-group">
						<label for="input1" class="form-label">Professional Chapters Category: </label>
						<select class="form-control" name="publication" id="publication">
							<option value="">Select</option>
							<?php 
								$pub = mysqli_query($con, "SELECT * FROM `tbl_mjcet_megha_menu_dept_section` WHERE menuName = 'Professional Chapters' AND status='1'"); 
