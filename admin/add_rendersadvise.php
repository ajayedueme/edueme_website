...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqladd = "INSERT INTO `tbl_mjcet_rendersadvise`(`pubSulg`, `pubName`, `pubDocument`, `pubOrder`, `status`, `addOn`) VALUES ('#', '{$txtname}', '{$thumbfile2}', '{$txtOrder}', '1', Now())";
	$res_add =  mysqli_query($con,$sqladd);
	
	header('Location:rendersadvise.php?msg=4');
	exit();
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Add</h1>
      <ol class="breadcrumb">
	  <li><a href="rendersadvise.php">Advice List</a></li>
