  ...
  <!-- Start Page Header -->
	...
	<div class="page-header" style="width: 100%; overflow: hidden;">
		...
		<div style="float: right;"> 
			<!-- <a class="btn btn-default" href="add_courses_home.php">Course
  Add</a> -->
		</div>
                    ...
                    <td width="4%"><?php echo $i ; $i++ ?></td>
						...
						<!-- <td width="8%">
							...
							<select class="form-control" name="statchnage" >
								<option  value="1r<?= $row_faq->coursesid?>" <?=$sel?> >Active</option>
								<option  value="0r<?= $row_faq->coursesid?>" <?=$unsel?> >Inactive</option>
							</select>
						</td> -->
                        <td width="10%">
							<a href="courses_details_add.php?id=<?php echo $row_faq->course_id;?>">Add & Edit</a> 
							<!-- <a class="delete" href="javascript:void(0)" data-id="<?php //echo $row_faq->coursesid;?>">Delete</a> -->
						</td>
                    </tr>
                   <?php } ?> 
                </tbody>
