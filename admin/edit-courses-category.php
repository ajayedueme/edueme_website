...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$order = htmlspecialchars(addslashes($_POST['order']));
	 ...
	 $sqlupdate = "UPDATE `tbl_course_categories` SET  `title`='{$txtname}', `date`=now(),`cat_order`='{$order}' WHERE id = '{$eid}'";
	...
	header('Location:courses-categorys.php?msg=4');
	exit();
	
}else{
	$sql = "SELECT * FROM tbl_course_categories WHERE id = '{$eid}'";
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Edit</h1>
      <ol class="breadcrumb">
	  <li><a href="courses-categorys.php">Course Categories</a></li>
			...
			<div class="panel-body">
	            <form name="frmChangepassword" id="frmChangepassword" enctype="multipart/form-data"  action="" method="POST">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="txtname" id="txtname" value="<?php echo $result->title?>">
					</div>
					...
					<div class="form-group">
						...
						<input type="Number" class="form-control" name="order" id="order" required value="<?php echo $result->cat_order?>">
					</div>
