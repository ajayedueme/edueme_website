...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqlupdate = "UPDATE `tbl_mjcet_announcements` SET `pageUrl`='{$txturl}', `pubName`='{$txtname}', `pubOrder`='{$txtOrder}', `status`='1' , `addOn`=now()";
	...
	echo $sql = "SELECT * FROM tbl_mjcet_announcements WHERE pubId = '{$eid}'";
			...
			<div class="panel panel-default">  <br>
				...
				<form name="frmChangepassword" id="frmChangepassword" enctype="multipart/form-data"  action="" method="POST">
					...
					<div class="form-group">
						...
						<textarea type="text" class="form-control" name="txtname" id="txtname" ><?php echo $result->pubName?></textarea>
					</div>
					<div class="form-group">
