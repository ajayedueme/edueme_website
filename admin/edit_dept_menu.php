...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqlupdate = "UPDATE `tbl_mjcet_megha_menu_dept_section` SET `menuName`='{$txtSectionMenuname}', `menuSulg`='{$txtURL}',`menuOrder`='{$txtOrder}'";
	...
	header('Location:dept_menu.php?msg=4');
	exit();
}else{
	$sql = "SELECT * FROM tbl_mjcet_megha_menu_dept_section WHERE tlmid = '{$eid}'";
