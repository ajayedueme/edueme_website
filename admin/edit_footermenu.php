...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqlupdate = "UPDATE `tbl_mjcet_footer_menu` SET `menuSulg` = '{$txtUrl}', `menuName` = '{$txtMenuname}', `menuOrder` = '{$txtMenuOrder}', `status` = '1' WHERE menuId = '{$eid}'";
	$res_add =  mysqli_query($con,$sqlupdate);
		
	header('Location:footermenu.php?msg=4');
	exit();
	
}else{
	$sql = "SELECT * FROM tbl_mjcet_footer_menu WHERE menuId = '{$eid}'";
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Update</h1>
      <ol class="breadcrumb">
	  <li><a href="footermenu.php">Footer Menu List</a></li>
