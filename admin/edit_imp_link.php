...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqlupdate = "UPDATE `tbl_mjcet_imp_links` SET `pageUrl`='{$txturl}', `pubName`='{$txtname}', `pubOrder`='{$txtOrder}', `pubContent`='{$txtContent}', `status`='1' , `addOn`=now()";
	...
	echo $sql = "SELECT * FROM tbl_mjcet_imp_links WHERE pubId = '{$eid}'";
