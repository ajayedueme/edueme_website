...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqlupdate = "UPDATE `tbl_mjcet_infrastructure` SET `pageUrl`='{$txturl}', `pubName`='{$txtname}', `pubOrder`='{$txtOrder}', `pubContent`='{$txtContent}', `status`='1' , `addOn`=now()";
	...
	echo $sql = "SELECT * FROM tbl_mjcet_infrastructure WHERE pubId = '{$eid}'";
