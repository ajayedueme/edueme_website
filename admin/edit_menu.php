...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqlupdate = "UPDATE `tbl_main_menu` SET `menuType` = '{$txtMenuType}', `menuSulg` = '{$txtUrl}', `menuName` = '{$txtMenuname}', `menuContent` = '{$txtMenuContent}', `menuOrder` = '{$txtMenuOrder}', `status` = '1'";
	...
	$sql = "SELECT * FROM tbl_main_menu WHERE menuId = '{$eid}'";
