...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqlupdate = "UPDATE `tbl_mjcet_side_menu` SET `menuSulg` = '{$txtUrl}', `menuName` = '{$txtMenuname}', `menuContent` = '{$txtMenuContent}', `menuOrder` = '{$txtMenuOrder}', `status` = '1'";
	...
	$sql = "SELECT * FROM tbl_mjcet_side_menu WHERE menuId = '{$eid}'";
