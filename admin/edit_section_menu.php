...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqlupdate = "UPDATE `tbl_mjcet_megha_menu_dept_section` SET `menuName`='{$txtSectionMenuname}', `menuSulg`='{$txtURL}',`menuOrder`='{$txtOrder}', `status`='1',`addOn`=now()";
	...
	$sqlupdate .= " WHERE tlmid = '{$eid}'";
	mysqli_query($con,$sqlupdate);
	header('Location:section_menu.php?msg=4');
	exit();
}else{
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Update Section Menu</h1>
      <ol class="breadcrumb">
	  <li><a href="section_menu.php">Section Menu List</a></li>
        <li class="active">Update Section Menu</li>
    </ol>
  ...
  <div class="panel-body">
	<?php 
		if(isset($_GET['msg']) && $_GET['msg'] =='2'){
			echo "<p style='color:red'>Document Deleted</p>";
		}
	?>
				...
				<form name="frmChangepassword" id="frmChangepassword" enctype="multipart/form-data"  action="" method="POST">
					...
					<div class="form-group">
						...
						<a href='../documents/<?php echo $result->menuDocument?>' target="_blank"><?php echo $result->menuDocument?></a>
					</div>
