...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqlupdate = "UPDATE `tbl_mjcet_first_submenu` SET `menuType` = '{$txtMenuType}', `menuSulg` = '{$txtUrl}', `menuTitle` = '{$menuTitle}', `menuName` = '{$txtMenuname}', `menuContent` = '{$txtMenuContent}', `menuContentTwo` = '{$txtMenuContent2}', `menuOrder` = '{$txtMenuOrder}', `status` = '1'";
	...
	$sql = "SELECT * FROM tbl_mjcet_first_submenu WHERE menuId = '{$eid}'";
