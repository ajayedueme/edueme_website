...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$sqlupdate = "UPDATE `tbl_mjcet_side_menu_content` SET `menuName` = '{$menuTitle}', `menuOrder` = '{$txtMenuOrder}', `status` = '1'";
	...
	$sql = "SELECT * FROM tbl_mjcet_side_menu_content WHERE menuId = '{$eid}'";
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Update Sub Menu</h1>
      <ol class="breadcrumb">
	  <li><a href="submenucontent.php">Sub Menu List</a></li>
			...
			<div class="panel panel-default">  <br>
				...
				<form name="frmChangepassword" id="frmChangepassword" enctype="multipart/form-data"  action="" method="POST">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="menuTitle" id="menuTitle" value="<?php echo $result->menuName?>">
					</div>
					<div class="form-group">
