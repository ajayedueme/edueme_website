...
if(isset($_POST['ADD']) && $_POST['ADD'] =='category'){
	...
	$order = htmlspecialchars(addslashes($_POST['txtMenuOrder']));
	
	$sqlupdate = "UPDATE `tbl_Testimonials` SET `uname` = '{$name}', `designation` = '{$designation}', `content` = '{$txtMenuContent}', `uorder` = '{$order}', `status` = '1'";
	...
	$sql = "SELECT * FROM tbl_Testimonials WHERE id = '{$eid}'";
...
<div class="content">
  ...
  <div class="page-header">
    <h1 class="title">Edit</h1>
      <ol class="breadcrumb">
	  <li><a href="testimonials.php">Testimonials
</a></li>
		...
		<div class="col-md-12 col-lg-6">
			<div class="panel panel-default">  <br>
				...
				<div class="form-group">
						...
						<input type="text" class="form-control" name="name" id="name" value="<?php echo $result->uname  ?>" required>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<a href="../uploades/<?php echo $result->profile ?>"><?php echo $result->profile?></a>
					...
					<div class="form-group" style="display:none">
						...
						<input type="radio" id="M" name="gender" value="1" <?php echo $result->gender == 1?"checked":""; ?> >
						<label for="html">Male</label><br>
						<input type="radio" id="F" name="gender" value="2" <?php echo $result->gender == 2?"checked":""; ?>>
						<label for="css">Female</label><br>
					</div>
					<div class="form-group">
						<label for="input1" class="form-label">About: </label>
						<textarea id="elm1" name="txtMenuContent"><?php echo $result->content?></textarea>
					</div>
					<div class="form-group">
						<label for="input1" class="form-label">Order: </label>
						<input type="text" value="<?php echo $result->uorder?>" class="form-control" name="txtMenuOrder" id="txtMenuOrder" required>
					</div>
