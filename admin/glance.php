...
$sqlfaq = "SELECT * FROM tbl_mjcet_glance Order BY coid";
...
<div class="content">
  ...
  <div class="page-header" style="width: 100%; overflow: hidden;">
     <div style="width: 600px; float: left;"> <h1 class="title" >Glance List</h1> </div>
     <div style="float: right;"> 
		<a class="btn btn-default" href="add_glance.php">Add</a>
	...
	$('.delete').click(function(e) {
		...
		if (r == true) {
			...
			$.ajax({
				...
				type:'post',
				data:{'action':"Delete",'tblname':'tbl_mjcet_glance','dltid':'coid','dltval':dltid},
