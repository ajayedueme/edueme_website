...
$sqlfaq = "SELECT * FROM tbl_mjcet_pdf";
...
<div class="content">
  ...
  <div class="page-header" style="width: 100%; overflow: hidden;">
     ...
     <div style="float: right;"> 
		<a class="btn btn-default" href="add_pdf.php">Add</a>
            ...
            <table id="example0" class="table display">
                ...
                <?php $i=1; while($row_faq = mysqli_fetch_object($res_faq)){?>
                    <tr>
                        ...
                        <td width="25%">
							<a href='../documents/<?php echo $row_faq->pdf;?>' target="_blank"><?php echo $row_faq->pdf;?></a>
						</td>
						<td width="20%">
							<input type="text" readonly value="<?php echo 'documents/'.$row_faq->pdf;?>" class="form-control select-this<?php echo $row_faq->pdfid;?>">
						</td>
