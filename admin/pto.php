...
$sqlfaq = "SELECT * FROM tbl_mjcet_pto WHERE status='1'";
...
<div class="content">
  ...
  <div class="page-header" style="width: 100%; overflow: hidden;">
     <div style="width: 600px; float: left;"> <h1 class="title" >P & TO List</h1> </div>
     <div style="float: right;"> 
		<a class="btn btn-default" href="add_pto.php">Add</a>
            ...
            <table id="example0" class="table display">
                ...
                <?php 
                    ...
                    <tr>
                        ...
                        <td width="30%"><?php echo ucfirst($row_faq->ptoTitle);?></td>
                        <td width="5%"><?php echo stripslashes($row_faq->ptoName);?></td>
                        <td width="5%">
