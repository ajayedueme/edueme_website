...
$sqlfaq = "SELECT * FROM tbl_mjcet_megha_menu_dept_section WHERE mainMenuId = '2'";
          ...
          <?php 
            ...
            <table id="example0" class="table display">
                ...
                <?php while($row_faq = mysqli_fetch_object($res_faq)){?>
                    <tr>
                        <td width="20%"><?php echo stripslashes($row_faq->menuCategory);?></td>
                        ...
                        <td width="10%" style="align:center">
							<a href="edit_section_menu.php?eid=<?php echo $row_faq->tlmid;?>">Edit</a>
						</td>
                    </tr>
                   <?php } ?> 
                </tbody>
