  ...
  <div class="fix_header">
    <header>
      <div class="wrapper">
        <div class="tz-t1">
          <div class="tz-r1">
            <div class="tz-c1"><a class="logoOuter" href="index.html"><img src="images/logo.png" class="logo-div" alt="logo" width="170" /></a></div>
            <div class="tz-c1">
              <div class="nav-main">
...
<div class="inner-banner-main">
  <div class="heading-banner-1">
    ...
    <div class="breadcrumb"> <a href="index.html">Home</a> <a href="Courses.html"><img src="images/bullet-3.svg">Courses</a> <a href="#"><img src="images/bullet-3.svg"><?php echo stripslashes(html_entity_decode($res_faq_get_fetch->courses_name)) ?></a> </div>
  </div>
